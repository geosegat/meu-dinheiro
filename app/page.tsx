        ...
        <div className="max-w-7xl mx-auto space-y-8">
          ...
          >
            <div>
              ...
              <p className="text-sm sm:text-base text-gray-500 mt-1">{t('dashboard.subtitle')}</p>
            </div>
            <div className="grid grid-cols-2 gap-2 sm:flex sm:flex-wrap sm:gap-3">
              ...
              >
                ...
                <span className="hidden sm:inline">{t('dashboard.newIncome')}</span>
                <span className="sm:hidden">{t('dashboard.newIncomeShort')}</span>
              </Button>
              <Button
                onClick={() => setShowExpenseForm(true)}
                className="bg-rose-600 hover:bg-rose-700 shadow-lg shadow-rose-600/20 flex-1 sm:flex-none"
              >
                <ArrowDownRight className="w-4 h-4 sm:mr-2" />
                <span className="hidden sm:inline">{t('dashboard.newExpense')}</span>
                <span className="sm:hidden">{t('dashboard.newExpenseShort')}</span>
              </Button>
            </div>
          </motion.div>
          ...
          >
            <h3 className="text-sm font-semibold text-gray-700 mb-3">{t('dashboard.period')}</h3>
